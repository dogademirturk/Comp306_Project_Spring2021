 ...
 * @author Murat Kaya
 */
public class main_agency_gains extends javax.swing.JFrame {

    /**
     * Creates new form main_agency_gains
     */
    
    static String username;
    
    public main_agency_gains(String uname) {
        username = uname;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        gainButton = new javax.swing.JRadioButton();
        ...
        jTextField4.setText("Total Gains of Agencies");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Agency ID", "Agency Name", "Average Gain"
            }
        ) {
        ...
        try{
            String query = "SELECT agencies.Agency_ID,agencies.Agency_Name, AVG(houses.Price*agencies.Commision_fee/100) FROM houses JOIN agencies ON agencies.Agency_ID=houses.Seller_Agency "
            ...
            while(rs.next()){
                ...
                String name=rs.getString("agencies.Agency_Name");
                String gain=String.valueOf(rs.getInt("AVG(houses.Price*agencies.Commision_fee/100)"));
                gain+="$";

                String tbData[]={id,name,gain};
    ...
    private void gainButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gainButtonActionPerformed
        ...
        try{
            String query = "SELECT agencies.Agency_ID,agencies.Agency_Name, AVG(houses.Price*agencies.Commision_fee/100) FROM houses JOIN agencies ON agencies.Agency_ID=houses.Seller_Agency "
                    + "Where houses.User_ID NOT IN (SELECT User_ID FROM HOUSES WHERE User_ID='') "
                    + "Group By agencies.Agency_ID, agencies.Agency_Name ORDER BY AVG(houses.Price*agencies.Commision_fee/100) DESC";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(main_agency_gains.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new main_agency_gains(username).setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JRadioButton gainButton;
